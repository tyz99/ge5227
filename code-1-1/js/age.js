require([
    ...
    (async () => {
      ...
      // Define a popup for Population
      const popupPopulation = {
        "title": "Population",
        "content": "<b>GEOID:</b> {GEO_ID}<br><b>Total Population:</b>{C01_001E} "
      }
      // Create the layer and set the popup
      const featureLayer = new FeatureLayer({
        portalItem: {
          id: "d8ffc3bc5d6a4322818c064134723143"
        },
        outFields: ["*"],
        ...
        view.when(() => {
          ...
          const legend = new Legend({
            ...
            layerInfos: [
              {
                layer: featureLayer,
                title: "2020 Population Density by Census tracts in Florida"
              }
            ]
          });
